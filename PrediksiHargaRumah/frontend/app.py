...
# API URL - Support Streamlit secrets
try:
            ...
            if overall_status == "insufficient_data":
                ...
                if features_drift:
                    ...
                    for feature, data in features_drift.items():
                        ...
                        cur_val = data.get("recent_mean", 0)
                    ...
                    tab_bar, tab_radar, tab_change = st.tabs(["Perbandingan Nilai", "Pola Karakteristik", "Tingkat Perubahan"])
